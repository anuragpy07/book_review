  ...
  return (
    <footer className="py-2 px-4 bg-slate-100 z-30 sm:flex items-center gap-2 border-t border-slate-200  sm:bg-white dark:bg-zinc-950 dark:border-zinc-800">
      ...
      <div className="sm:ml-auto flex items-center justify-center gap-2 ">
        <Link to="https://www.linkedin.com/in/anurag-kumar-8b1b3323b/" target="_blank">
          <Button variant="outline" size="icon">
            <FaLinkedinIn className="h-6 w-6" />
            <span className="sr-only">Linkedin</span>
          </Button>
        </Link>
        <Link to="https://github.com/anuragpy07" target="_blank">
          <Button variant="outline" size="icon">
            <FaGithub className="h-6 w-6" />
            <span className="sr-only">Github</span>
          </Button>
        </Link>
        <Link to="https://leetcode.com/u/Nexify07/" target="_blank">
          <Button variant="outline" size="icon">
            <SiLeetcode className="h-6 w-6" />
            <span className="sr-only">Leetcode</span>
          </Button>
        </Link>
        <Link to="https://www.codechef.com/users/nexify07" target="_blank">
          <Button variant="outline" size="icon">
        ...
        <Link
          to="https://www.geeksforgeeks.org/user/anuragpy07/"
          target="_blank">
          <Button variant="outline" size="icon">
        ...
        <Link
          to="https://www.youtube.com/@AnuragPy07"
          target="_blank">
          <Button variant="outline" size="icon">
        ...
        <Link to="https://www.instagram.com/anuragpandey.ap_/" target="_blank">
          <Button variant="outline" size="icon">
